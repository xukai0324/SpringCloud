        ...
        ['$scope', '$element', '$timeout', '$filter', '$$uisDebounce', 'uisRepeatParser', 'uiSelectMinErr', 'uiSelectConfig', '$parse', '$injector', '$window',
            function($scope, $element, $timeout, $filter, $$uisDebounce, RepeatParser, uiSelectMinErr, uiSelectConfig, $parse, $injector, $window) {
                ...
                ctrl.parseRepeatAttr = function(repeatAttr, groupByExp, groupFilterExp) {
                    ...
                    //If intelligence is an Object, convert it to Array
                    ...
                    $scope.$watchCollection(ctrl.parserResult.source, function(items) {
                        if (items === undefined || items === null) {
                            // If the user specifies undefined or null => reset the intelligence
                            // Special case: items can be undefined if the user did not initialized the intelligence on the scope
                ...
                /**
                 * Typeahead mode: lets the user refresh the intelligence using his own function.
                 *
...
// Make multiple matches sortable
    ...
    uis.service('uisRepeatParser', ['uiSelectMinErr','$parse', function(uiSelectMinErr, $parse) {
        ...
        self.parse = function(expression) {
            ...
            // If an array is used as intelligence
